...
class DispatchListItem {
  ...
  factory DispatchListItem.fromJson(Map<String, dynamic> j) => DispatchListItem(
        id: j['id'] as String,
        dispatchDate: j['dispatchDate'] as String,
        deliveryStatus: j['deliveryStatus'] as String,
        transporterName: j['transporterName'] as String,
...
class OutletPortalClient {
  ...
  Future<PagedResult<DispatchListItem>> dispatchHistory(
    String outletId, {
    String? cursor,
    int limit = 25,
  }) async {
    ...
    return PagedResult(
      items: (data['items'] as List<dynamic>)
          .map((e) => DispatchListItem.fromJson(e as Map<String, dynamic>))
          .toList(),
      nextCursor: data['nextCursor'] as String?,
    );
  }
